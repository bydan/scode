...
public class SubProceso {
	...
	public Int64 id_proceso;
	
	public Int64 id_tipo_sub_proceso;
	...
	public SubProceso () : base() {			
		
		this.id=0L;
		
		
		this.id_proceso=-1L;
 		this.id_tipo_sub_proceso=-1L;
	...
	public   Int64 idProceso_ { 
		get {
			return this.id_proceso;
		}
		set {
			this.setid_proceso(value);
			//this.id_proceso = value;
		}
	}
	
	public   Int64 idTipoSubProceso_ { 
		get {
			return this.id_tipo_sub_proceso;
		}
		set {
			this.setid_tipo_sub_proceso(value);
			//this.id_tipo_sub_proceso = value;
		}
	}
	...
	public Int64 getid_proceso() {
		return this.id_proceso;
	}
    
	public Int64 getid_tipo_sub_proceso() {
		return this.id_tipo_sub_proceso;
	}
	...
	public void setid_proceso(Int64 newid_proceso)
	{
		try {
			if(this.id_proceso!=newid_proceso) {
				if(newid_proceso==null) {
					//newid_proceso=-1L;
				}

				this.id_proceso=newid_proceso;
			}
		} catch(Exception e) {
			throw e;
		}
	...
	public void setid_tipo_sub_proceso(Int64 newid_tipo_sub_proceso)
	{
		try {
			if(this.id_tipo_sub_proceso!=newid_tipo_sub_proceso) {
				if(newid_tipo_sub_proceso==null) {
					//newid_tipo_sub_proceso=-1L;
				}

				this.id_tipo_sub_proceso=newid_tipo_sub_proceso;
			}
		} catch(Exception e) {
			throw e;
		}
		...
		try {
			if(this.esquema!=newesquema) {
				...
				if(newesquema!=null&&newesquema.Length>30) {
					...
					//System.out.println("SubProceso:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=30 en columna esquema");
				}
		...
		try {
			if(this.tabla!=newtabla) {
				...
				if(newtabla!=null&&newtabla.Length>30) {
					...
					//System.out.println("SubProceso:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=30 en columna tabla");
				}
		...
		try {
			if(this.columna!=newcolumna) {
				...
				if(newcolumna!=null&&newcolumna.Length>50) {
					...
					//System.out.println("SubProceso:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=50 en columna columna");
				}
		...
		try {
			if(this.columnas!=newcolumnas) {
				...
				if(newcolumnas!=null&&newcolumnas.Length>200) {
					...
					//System.out.println("SubProceso:Ha sobrepasado el numero maximo de caracteres permitidos,Maximo=200 en columna columnas");
				}
